...
export interface NotiState extends Notification {
  id: string,
  time: number,
...
export const CreateSuccessNoti = (msg: any, buttons?: NotiferButton[]) => CreateNotification({
  icon: '/images/notifier/success.png',
  title: 'Success',
  body: msg,
  buttons
})

export const CreateInfoNoti = (msg: any, buttons?: NotiferButton[]) => CreateNotification({
  icon: '/images/notifier/info.png',
  title: 'Information.',
  body: msg,
  buttons
})

export const CreateErrorNoti = (msg: any, buttons?: NotiferButton[]) => CreateNotification({
  icon: '/images/notifier/error.png',
  title: 'Failed.',
  body: msg,
  buttons
})
...
export const Notifier: FC = () => {
  const [notifications, setNotifications] = useState([] as NotiState[]);
  const countDownTime = 5;

  CreateNotification = (payload: Notification) => {
    const newNoti: NotiState = {
      ...payload,
      id: generateID(),
      time: countDownTime,
      countDownTime
...
const NotificationItem: FC<{ data: NotiState, removeNotification: () => any, onChangeTime: (time: number) => any }> = (props) => {
