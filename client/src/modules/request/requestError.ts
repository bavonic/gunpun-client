...
export class RequestError extends Error {
  ...
  constructor(error: any) {
    ...
    // this.message = responseErrorMessage ? translate(responseErrorMessage) : 'Unknow error from the system';
    this.message = responseErrorMessage ? responseErrorMessage : 'Unknown error from the system';
